# Generated by Django 4.2.5 on 2023-09-08 01:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorited_cats', models.ManyToManyField(related_name='favorited_by', through='musickittyapi.CatFavorite', to='musickittyapi.cat')),
            ],
        ),
        migrations.CreateModel(
            name='Reservation',
        ...
        migrations.AddField(
            ...
            name='profile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='musickittyapi.profile'),
        ),
        migrations.AddField(
            model_name='cat',
            name='location',
